...
<div class="max-w-xl mx-auto space-y-5">
    ...
    <div class="bg-white rounded-2xl border border-gray-200 p-6">
        <h3 class="font-semibold text-gray-900 mb-5">Tambah Kategori Buku</h3>
        <form method="POST" action="{{ route('admin.kategori.store') }}" class="space-y-4">
            ...
            <div>
                ...
                <textarea name="deskripsi" rows="3"
                    class="w-full px-3 py-2.5 border border-gray-300 rounded-xl text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            ...
            <div class="flex justify-end gap-3 pt-2">
                ...
                <button type="submit" class="px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl text-sm font-semibold transition flex items-center gap-2">
                    <i class="fa fa-floppy-disk"></i> Simpan Kategori
                </button>
            </div>
        </form>
    </div>
